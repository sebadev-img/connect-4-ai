...
def pick_best_move(board,piece):
    drop_col,drop_col_score = simulation_system.get_best_col(board,piece)
    kill_row,kill_row_score = simulation_system.get_best_kill_row(board,piece)
    kill_col,kill_col_score = simulation_system.get_best_kill_col(board,piece)
